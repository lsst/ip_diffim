...
#         connections.subtractedMeasuredExposure: nightly_difference_image
...
#       connections.diffImVisitInfo: nightly_difference_image.visitInfo
...
class AssembleNightlyCoaddConnections(
    ...
    # Need to have this defined so it can be removed in base class

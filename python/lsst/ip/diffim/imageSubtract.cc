...
void declareConvolveAndSubtract(py::module &mod) {
    ...
    mod.def(
        "convolveAndSubtract", (afw::image::MaskedImage<PixelT>(*)(
                                   afw::image::Image<PixelT> const &, afw::image::MaskedImage<PixelT> const &,
                                   afw::math::Kernel const &, BackgroundT, bool)) &
                                   convolveAndSubtract,
        "templateImage"_a, "scienceMaskedImage"_a, "convolutionKernel"_a, "background"_a, "invert"_a = true);
}

...
print "\n-------Start mpiNricAllDist_WcsPerMEF on "+str(myid)+"...."
...
cmd = ("/usr/bin/time mpirun -ssi rpi lamd -D -O -sigs -np "+str(nCCD)+" "+rootDir+"/mpiNrayAllDist_WcsPerHdu.py "+rootDir)
print "MPI call: "+cmd
res = os.system(cmd)
...
mpi.mpi_finalize()
print "End mpiNricAllDist_WcsPerMEF"

...
print "Star match and WCS build on all target CCDs from FIC.\nStart test9.fic...."
...
for i in range(immef.NumCCDS()):
    ...
    try:
        ...
        try:
            ...
            print ("Test9.fic: failed during WCS construction for HDU:%d\n" % (i))
    except:
        print ("Test9.fic: No stars matched, so no WCS constructed for HDU:%d\n"% (i))

...
int main( int argc, char** argv )
{
    ...
    if (0) {
        ...
        lsst::fw::Kernel<ImageT>::KernelFunctionPtrType deltaFuncPtr(new lsst::fw::function::IntegerDeltaFunction2<ImageT>(colCtr, rowCtr));
        ...
        lsst::fw::MaskedImage<ImageT, MaskT> convolvedTemplateMaskedImage = 
            lsst::fw::kernel::convolve(templateMaskedImage, deltaKernel, threshold, edgeMaskBit);
